...
@Command(
        command = "/track",
        description = "Начать отслеживать новую ссылку по URL",
        states = {UserState.MENU})
public class TrackCommandHandler extends AbstractTelegramCommandHandler {
    ...
    public String getHandlerName() {
        return CommandNameEnum.TRACK.getName();
    }
}
